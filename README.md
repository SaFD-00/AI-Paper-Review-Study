...
2023-2분기 [2023-09 ~ 2024-02] <br><br>

Computer Vision, NLP, Reinforcement Learning, Time-series Forecasting 등 다양한 딥러닝 분야의 논문을 리뷰합니다.<br><br>

과거 스터디 발표 자료는 이 GitHub 레포지토리에 정리되어 있으며,<br>
**최근 스터디에서 정리한 내용과 기술 블로그 형태의 리뷰 글은 OUTTA 블로그에 업로드 중입니다.**<br>
👉 <a href="https://blog.outta.ai" target="_blank">https://blog.outta.ai</a>
<br><br><br>

<a id="ch2"><h3>🍆 진행</h3></a>
<hr>
<p>
  <li>매주 목요일 진행 (세부 일정은 아래 <a href="#ch6">일정</a> 참고)</li>
  <li>매주 2편 내외의 논문 리뷰 및 관련 실습</li><br>
  ...
  <li><strong>[발표 후]</strong><br>
    &nbsp; &nbsp; &nbsp; &nbsp; (발표자) 
    - 단톡방에 발표 자료 공유<br>
    &nbsp; &nbsp; &nbsp; &nbsp; - 이 레포지토리에 발표 자료 업로드<br>
    &nbsp; &nbsp; &nbsp; &nbsp; - 정리된 리뷰 글은 <a href="https://blog.outta.ai" target="_blank">OUTTA 블로그</a>에 게시</li>
 </p>
<br><br>
...
<p>아래와 같은 사이트에 task를 검색해서 논문을 찾거나,<br>
  구글에서 먼저 task를 검색한 후 키워드를 잡아서 논문을 검색해보셔도 좋습니다.</p>
...
<br>
※ 이후 기수의 스터디 결과/정리 글은 <a href="https://blog.outta.ai" target="_blank">OUTTA 블로그</a>에 순차적으로 업로드되고 있습니다.<br>
<br><br>
...
| 01  | 2022년 11월 27일 | 연세대학교 학생회관 313호     | [이동훈 : "Deep Residual Learning for Image Recognition"](2022_11_27/Deep%20Residual%20Learning%20for%20Image%20Recognition.pdf)<br> [황주훈 : "Generative Adversarial Networks"](2022_11_27/GAN.pdf) |  
...
| 07  | 2023년 6월 1일  | ZOOM                   | [박용주 : "Text Extraction and Detection from Images using Machine Learning Techniques"](2023_06_01/Text_Extraction_and_Detection_from_Images_using_Machine_Learning_Techniques.pdf) <br> [백승우 : "VATT"](2023_06_01/VATT_PPT.pdf) |
